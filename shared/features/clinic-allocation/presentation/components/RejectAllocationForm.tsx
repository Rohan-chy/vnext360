...
import { useApproveRejectAllocationForm } from '../../domain/approveRejectAlloction.schema';

const RejectAllocationForm = ({
  initialValues,
  handleApproveReject,
  loading,
}: any) => {
  const form = useApproveRejectAllocationForm(initialValues);
...
export default RejectAllocationForm;
