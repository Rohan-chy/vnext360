...
import { useUploadClinicBulkImageHandle } from '../hooks/useUploadClinicBulkImageHandle';
...
const UploadClinicBulkImages = ({ data }: props) => {
  const {
    open,
    setOpen,
    files,
    ...
    handleSubmit,
    loading,
  } = useUploadClinicBulkImageHandle(data);
...
export default UploadClinicBulkImages;
