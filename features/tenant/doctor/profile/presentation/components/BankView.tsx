...
import { blue_color, green_color } from '@/shared/css/colorTheme';
              ...
              >
                ...
                <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorBankDetails.${index}.bankName`}
                    label="Bank Name"
                  />

                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorBankDetails.${index}.accountType`}
                    label="Account Type"
                  />

                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorBankDetails.${index}.accountName`}
                    label="Account Name"
                  />

                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorBankDetails.${index}.accountNumber`}
