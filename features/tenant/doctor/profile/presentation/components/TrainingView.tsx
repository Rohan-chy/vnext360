                ...
                <div className="p-5 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorTrainings.${index}.trainingTitle`}
                      label="Training Title"
                    />

                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorTrainings.${index}.durationInMonths`}
                    ...
                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorTrainings.${index}.yearOfCompletion`}
                    ...
                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorTrainings.${index}.completedFromInstitute`}
                    ...
                    <Combobox
                      ...
                      form={form}
                      name={`doctorTrainings.${index}.dynamicDocumentTypeId`}
                      label="Document Type"
                    />
                    ...
                    <FloatingLabelFormInput
                      type="file"
                      form={form}
                      name={`doctorTrainings.${index}.documentUrl`}
                      ...
                      onChange={(event) => {
                        ...
                        const dynamicDocumentTypeId = getValues(
                          `doctorTrainings.${index}.dynamicDocumentTypeId`
                        );
                    ...
                    <div className="col-span-full">
                      <FormTextArea
                        form={form}
                        name={`doctorTrainings.${index}.remarks`}
