...
import { blue_color } from '@/shared/css/colorTheme';
              ...
              >
                ...
                <div className="p-5 grid grid-cols-1 md:grid-cols-3 gap-6">
                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorRelatives.${index}.name`}
                    label="Name"
                  />

                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorRelatives.${index}.relationship`}
                    label="Relation"
                  />

                  <FloatingLabelFormInput
                    form={form}
                    name={`doctorRelatives.${index}.contactNumber`}
