                ...
                <div className="p-5 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorResearches.${index}.researchTitle`}
                      label="Research Title"
                    />

                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorResearches.${index}.yearOfCompletion`}
                    ...
                    <FloatingLabelFormInput
                      form={form}
                      name={`doctorResearches.${index}.researchOutcome`}
                    ...
                    <Combobox
                      ...
                      form={form}
                      name={`doctorResearches.${index}.dynamicDocumentTypeId`}
                      label="Document Type"
                    />
                    ...
                    <FloatingLabelFormInput
                      type="file"
                      form={form}
                      name={`doctorResearches.${index}.documentUrl`}
                      ...
                      onChange={(event) => {
                        ...
                        const dynamicDocumentTypeId = getValues(
                          `doctorResearches.${index}.dynamicDocumentTypeId`
                        );
                    ...
                    <div className="col-span-full">
                      <FormTextArea
                        form={form}
                        name={`doctorResearches.${index}.remarks`}
