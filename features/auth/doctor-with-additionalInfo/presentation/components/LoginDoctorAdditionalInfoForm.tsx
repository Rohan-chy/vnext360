...
const DoctorLoginAdditionalForm = () => {
  const router = useRouter();

  const loginForm = useDoctorLoginForm();

  const { mutate: login, isPending } = useLoginAdditionalInfo(
    'Doctor',
    'session'
  );
          ...
          >
            ...
            <div className="text-right">
              <button
                ...
                onClick={() => router.push('/doctor/forgotPassword')}
              >
                Forgot Password?
              </button>
            </div>
...
export default DoctorLoginAdditionalForm;
